...
_defineProperty(Socket, "open", function (url = "ws" + (Client.loader.settings.socket.ssl ? "s" : "") + "://" + Client.loader.settings.socket.address + ":" + Client.loader.settings.socket.port + "/" + key) {
