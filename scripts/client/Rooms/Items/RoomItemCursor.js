Client.rooms.items.cursor = function(parent) {
    ...
    entity.render = async function() {
        const cursors = await Client.assets.getManifest("HabboRoomCursors");
        ...
        sprite.setOffset(cursors.visualization["default"].offset.left, cursors.visualization["default"].offset.top);
